...
public class Main {
    ...
    static String pilih, admin,pilih2,pilih3;
    ...
    public static void main(String[] args) {
        Boolean restart5,restart1,restart2,restart3,restart4;
        restart5 = true;
        while (restart5){
            menu();
            switch (pilih2){
    ...
    public static String menuCostumer(){
        clearScreen();
        System.out.println("\t ___                         ___  ");
        System.out.println("\t|   |_______________________|   | ");
        System.out.println("\t|                               | ");
